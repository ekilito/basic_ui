import { defineComponent as u, resolveComponent as c, createBlock as s, openBlock as t, mergeProps as M, withCtx as i, createElementBlock as l, Fragment as d, renderList as z, createCommentVNode as m, createElementVNode as e, resolveDynamicComponent as f, toDisplayString as x, useAttrs as H, createVNode as v, isVNode as V } from "vue";
const y = /* @__PURE__ */ u({
  __name: "index",
  props: {
    // 导航菜单的数据
  ...
  setup(a) {
    return (r, _) => {
      const h = c("el-menu-item"), n = c("el-sub-menu"), p = c("el-menu");
      return t(), s(p, M({
        "default-active": a.defaultActive,
        router: a.router
      }, r.$attrs, { class: "el-menu-vertical-demo" }), {
        default: i(() => [
          (t(!0), l(
            d,
            null,
            z(a.data, (o, w) => (t(), l(
              ...
              { key: w },
              [
                !o[a.children] || !o[a.children].length ? (t(), s(h, {
                  key: 0,
                  index: o[a.index]
                }, {
                  default: i(() => [
                    o[a.icon] ? (t(), s(f(o[a.icon]), { key: 0 })) : m("v-if", !0),
                    e(
                      "span",
                      null,
                      x(o[a.name]),
                ...
                o[a.children] ? (t(), s(n, {
                  ...
                  default: i(() => [
                    (t(!0), l(
                      d,
                      null,
                      z(o[a.children], (g, C) => (t(), s(h, {
                        key: C,
                        index: g[a.index]
                      }, {
                        default: i(() => [
                          g[a.icon] ? (t(), s(f(o[a.icon]), { key: 0 })) : m("v-if", !0),
                          e(
                            "span",
                            null,
                            x(g[a.name]),
  ...
  for (const [h, n] of r)
    _[h] = n;
  return _;
}, L = /* @__PURE__ */ B(y, [["__scopeId", "data-v-c54f9ff5"]]);
...
const z_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: i0,
  CircleCheck: g0,
  CircleCheckFilled: d0,
  CircleClose: M0,
  CircleCloseFilled: x0,
  CirclePlus: y0,
  CirclePlusFilled: H0,
  Clock: L0,
  Close: S0,
  ...
  Van: Et,
  VideoCamera: jt,
  VideoCameraFilled: Zt,
  VideoPause: $t,
  VideoPlay: Xt,
  View: e_,
  Wallet: r_,
  WalletFilled: t_,
  WarnTriangleFilled: u_,
  Warning: n_,
  WarningFilled: p_,
  Watch: s_,
  Watermelon: i_,
...
const C_ = /* @__PURE__ */ u({
  ...
  setup(a, r) {
    let _ = (n) => n.map((p) => {
      const o = z_[p[a.icon]];
      let w = {
        title: () => v(d, null, [v(c("el-icon"), null, {
          default: () => [o && v(o, null, null)]
        }), v("span", null, [p[a.name]])])
      };
      return p[a.children] && p[a.children].length ? v(c("el-sub-menu"), {
        index: p[a.index]
      }, {
  ...
  install(a) {
    a.component("a-menu", L), a.component("a-infinite-menu", C_);
  }
};
export {
  V_ as default
